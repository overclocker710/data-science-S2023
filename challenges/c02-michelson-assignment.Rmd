...
author: Daniel Heitz 02/08/2023
output:
  github_document:
    toc: true
prerequisites:
...
-   When graphing velocity vs temperature there was more variation in
    the real results than the simulated ones. I think this might have to
    do with the fact that since Michelson could not create a good
    vacuum, the presence of air causes temperature to have an effect. If
    it were a vacuum there could be no temperature.
-   The Distinctness makes an impact on the measured velocity, although
    I am not sure why. The trends in the real data more or less mirror
    the simulated data.
