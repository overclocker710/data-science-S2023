...
-   Is there "one true value" for the material properties of Aluminum?
    -   Not really, there is an average and you can give a range a la boxplot,
        but the mean doesn't really do it justice, there is a substantial
        amount of variation.
...
-   The interquartile range when graphing angle has so much overlap, in addition to the fact that the medians display no trend, that I would have to say angle does not affect elasticity. Thickness, however, does have a meaningful impact, even including outliers, there is no overlap between the thickest group and any of the other groups, it is too far below them. Additionally among the 3 thinner groups they also display the same trend to a lesser extent.
...
-   Does this graph support or contradict the claim above?
    -   This evidence in addition to my evidence suggests a contradiction of the above statement, however I would venture to say that this statement can still be trusted. The variation in elasticity caused by a factor of 4 in the thickness is only 5%. From a practical perspective you can say thickness doesn't affect elasticity, but it does have a small but measurable impact.
