...
uncertainty was less than the true error - Make a quantitative
comparison between Michelson’s uncertainty and his error. - Michelson’s
uncertainty was 1/3 of the true error.
...
**Observations**: Similarities - The general trends, there is that
rounded off peak at both beginnings followed by a drop, etc.
Differences - The simulated data line spends a higher proportion of the
time between the two bounding lines.
...
- The Distinctness makes an impact on the measured velocity, although I
  ...
  simulated data.
- The date of the measurement has an effect, although it mostly stays
